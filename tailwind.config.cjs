...
export default {
  ...
  backgroundImage: {
        ...
        /* --- AQUÍ ESTÁ EL CAMBIO --- */
        /* Cambié 60% a 75% para empujar el triángulo negro a la derecha */
        hero: 'linear-gradient(135deg, rgba(244,244,246,0.8) 65%, rgba(10,10,10,0.95) 63%)',
        
        /* También ajustamos la versión móvil un poco si quieres */
        'hero-mobile':
          'linear-gradient(137deg, rgba(244,244,246,0.8) 70%, rgba(10,10,10,1) 70%)',
